...
function getTime() {
  ...
  const titleMonts = now.getMonth();
  fullDay.textContent = `${date} ${months[titleMonts]},${year}`;
...
formCreate.addEventListener("submit", (e) => {
  ...
  if (todoText.length) {
    ...
    showMassage("message-create", "Please,enter some text!");
  }
});
...
formEdit.addEventListener("submit", (e) => {
  ...
  if (todoText.length) {
    ...
    showMassage("message-edit", "Please,enter some text!");
  }
});
//editTodo
